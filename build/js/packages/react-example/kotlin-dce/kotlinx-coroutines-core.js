(function (root, factory) {
  ...
  function AwaitAll(deferreds) {
    ...
    this.notCompletedCount_0 = atomic_0(this.deferreds_0.length);
  }
  ...
  function AwaitAll$AwaitAllNode($outer, continuation) {
    ...
    this._disposer_0 = atomic(null);
  }
  Object.defineProperty(AwaitAll$AwaitAllNode.prototype, 'handle', {configurable: true, get: function () {
  ...
  Object.defineProperty(AwaitAll$AwaitAllNode.prototype, 'disposer', {configurable: true, get: function () {
    return this._disposer_0.kotlinx$atomicfu$value;
  }, set: function (value) {
    this._disposer_0.kotlinx$atomicfu$value = value;
  }});
  AwaitAll$AwaitAllNode.prototype.invoke = function (cause) {
    ...
    } else if (this.$outer.notCompletedCount_0.atomicfu$decrementAndGet() === 0) {
